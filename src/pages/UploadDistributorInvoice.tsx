...
const UploadDistributorInvoice = () => {
  ...
  const uploadDistributorInvoiceMutation = useMutation({
    mutationFn: async () => {
      if (!user || !selectedCompanyPO || !invoiceFile || !invoiceNumber) {
      ...
      <div className="max-w-2xl mx-auto">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Upload an invoice received from the distributor
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              disabled={!selectedCompanyPO || !invoiceNumber || !invoiceFile || uploadDistributorInvoiceMutation.isPending}
              className="w-full"
            >
